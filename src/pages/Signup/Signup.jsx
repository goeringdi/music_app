    ...
    <S.Container>
      <S.FormWrapper>
        <S.Form>
          ...
          <S.Input placeholder="Имя" type="text" onChange={handleLoginChange} />
          {error && error.data.username && (
            <S.ErrorNameMessage>{error.data.username[0]}</S.ErrorNameMessage>
          )}
          <S.Input
            placeholder="Email"
            type="text"
          ...
          {error && error.data.email && (
            <S.ErrorEmailMessage>{error.data.email[0]}</S.ErrorEmailMessage>
          )}
          <S.Input
            placeholder="Пароль"
            type="password"
